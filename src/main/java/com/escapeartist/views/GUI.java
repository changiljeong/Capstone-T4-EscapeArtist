...
public class GUI extends JFrame {
  ...
  public GUI(GameTimer gameTimer) {
    ...
    JLabel timerLabel = new JLabel("Time: " + gameTimer.getFormattedRemainingTime());
    outputPanel.add(timerLabel);

    timerLabel.setHorizontalAlignment(SwingConstants.RIGHT);
    outputPanel.setLayout(new BorderLayout());
    outputPanel.add(timerLabel, BorderLayout.NORTH);

    // Update the timer label every second using Timer class
    timer = new Timer(1000, new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        timerLabel.setText("Time: " + gameTimer.getFormattedRemainingTime());
        if (gameTimer.hasTimeExpired()) {
          timer.stop();
          JOptionPane.showMessageDialog(GUI.this, "The Main Boss has Entered!");
        }
      }
    });
    timer.start();
    ...
    button5.addActionListener(new ActionListener() {
      ...
      public void showGameIntro(String introText) {
        ...
        JOptionPane.showMessageDialog(this, introPanel, "Game Introduction",
